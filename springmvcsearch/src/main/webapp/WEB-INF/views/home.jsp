...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>   
   <!--JSTL taglib from net to work with css,js file attacheme  -->
<!doctype html>
<html lang="en">
  <head>
    <!-- Required meta tags -->
...
<script src="<c:url value="/resources/js/script.js"/> "></script>
 ...
 <h1 class="text-center py-5"   >My own search using google Search </h1>
 <div class="container">
...
<form  action="search" class="mt-5">
   ...
   <input type="text" name="querybox" placeholder="Enter your word" class="form-control" />
   </div>
